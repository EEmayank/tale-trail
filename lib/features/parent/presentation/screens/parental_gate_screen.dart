...
class ParentalGateScreen extends ConsumerStatefulWidget {
  ...
  /// Route to push to after successful verification.
  final String? redirectTo;

  @override
  ConsumerState<ParentalGateScreen> createState() =>
      _ParentalGateScreenState();
}
...
class _ParentalGateScreenState extends ConsumerState<ParentalGateScreen>
  ...
  void _generateMathChallenge() {
    ...
    _mathA = 10 + rng.nextInt(90);
    _mathB = 10 + rng.nextInt(90);
  }
  ...
  void _onVerified() {
    ...
    if (mounted) {
      context.go(widget.redirectTo ?? '/parent/settings');
    }
  }
            ...
            Center(
              child: SingleChildScrollView(
                padding: const EdgeInsets.symmetric(
                  ...
                  vertical: TaleDimensions.paddingXxl,
                ),
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _useMathChallenge
                          ? 'Solve this quick maths to continue'
                    ...
                    // Math challenge or PIN UI
                    if (_useMathChallenge)
                      _FullScreenMathChallenge(
                        a: _mathA,
                        b: _mathB,
                      ...
                      AnimatedSwitcher(
                        ...
                        child: _errorMessage != null
                            ...
                            : const SizedBox(
                                height:
                                    TaleDimensions.paddingMd + 20),
                      ),

                      const SizedBox(height: TaleDimensions.paddingLg),

                      // Numpad (64px full-screen buttons)
                      _isLoading
                          ? const Padding(
...
// ---------------------------------------------------------------------------
// Full-screen math challenge
// ---------------------------------------------------------------------------

class _FullScreenMathChallenge extends StatelessWidget {
  const _FullScreenMathChallenge({
    required this.a,
    required this.b,
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide:
                  const BorderSide(color: TaleColors.warmGrey200),
            ),
